...
/**
 * Provides the local service interface for FriendshipRecognition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author hong
 * @see FriendshipRecognitionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface FriendshipRecognitionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>hong.recog.service.impl.FriendshipRecognitionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the friendship recognition local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FriendshipRecognitionLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public FriendshipRecognition addFriendshipRecognition(
	...
	public FriendshipRecognition createFriendshipRecognition(
		long recognitionId);
	...
	public FriendshipRecognition deleteFriendshipRecognition(
		FriendshipRecognition friendshipRecognition);
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public FriendshipRecognition deleteFriendshipRecognition(long recognitionId)
		throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FriendshipRecognition fetchFriendshipRecognition(long recognitionId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public FriendshipRecognition getFriendshipRecognition(long recognitionId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<FriendshipRecognition> getFriendshipRecognitions(
		int start, int end);
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public FriendshipRecognition updateFriendshipRecognition(
		FriendshipRecognition friendshipRecognition);
