...
/**
 * Provides the local service interface for Recognition. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author hong
 * @see RecognitionLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RecognitionLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>hong.recog.service.impl.RecognitionLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the recognition local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link RecognitionLocalServiceUtil} if injection and service tracking are not available.
	 */
