...
/**
 * Provides the base implementation for the friendship recognition local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link hong.recog.service.impl.FriendshipRecognitionLocalServiceImpl}.
 * </p>
 *
 * @author hong
 * @see hong.recog.service.impl.FriendshipRecognitionLocalServiceImpl
 * @generated
 */
public abstract class FriendshipRecognitionLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, FriendshipRecognitionLocalService,
			   IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FriendshipRecognitionLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>hong.recog.service.FriendshipRecognitionLocalServiceUtil</code>.
	 */
	...
	public FriendshipRecognition addFriendshipRecognition(
		...
		return friendshipRecognitionPersistence.update(friendshipRecognition);
	}
	...
	public FriendshipRecognition createFriendshipRecognition(
		...
		return friendshipRecognitionPersistence.create(recognitionId);
	}
	...
	public FriendshipRecognition deleteFriendshipRecognition(long recognitionId)
		...
		return friendshipRecognitionPersistence.remove(recognitionId);
	}
	...
	public FriendshipRecognition deleteFriendshipRecognition(
		...
		return friendshipRecognitionPersistence.remove(friendshipRecognition);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			FriendshipRecognition.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return friendshipRecognitionPersistence.findWithDynamicQuery(
			dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return friendshipRecognitionPersistence.countWithDynamicQuery(
			dynamicQuery);
	}
	...
	@Override
	public FriendshipRecognition fetchFriendshipRecognition(
		long recognitionId) {

		return friendshipRecognitionPersistence.fetchByPrimaryKey(
			recognitionId);
	}
	...
	public FriendshipRecognition getFriendshipRecognition(long recognitionId)
		...
		return friendshipRecognitionPersistence.findByPrimaryKey(recognitionId);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setModelClass(FriendshipRecognition.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return friendshipRecognitionPersistence.create(
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return friendshipRecognitionLocalService.deleteFriendshipRecognition(
			(FriendshipRecognition)persistedModel);
	}

	public BasePersistence<FriendshipRecognition> getBasePersistence() {
		return friendshipRecognitionPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return friendshipRecognitionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<FriendshipRecognition> getFriendshipRecognitions(
		...
		return friendshipRecognitionPersistence.findAll(start, end);
	}
	...
	public int getFriendshipRecognitionsCount() {
		return friendshipRecognitionPersistence.countAll();
	}
	...
	public void setAopProxy(Object aopProxy) {
		friendshipRecognitionLocalService =
			(FriendshipRecognitionLocalService)aopProxy;
	}
	...
	public String getOSGiServiceIdentifier() {
		return FriendshipRecognitionLocalService.class.getName();
	}
	...
	protected FriendshipRecognitionLocalService
		friendshipRecognitionLocalService;
